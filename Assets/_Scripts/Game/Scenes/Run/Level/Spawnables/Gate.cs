...
public class Gate : Spawnable
{
    ...
    protected override void Awake()
    {
        ...
        if (m_GateType == GateType.ChangeAttackRate)
        {
            m_Text.GetComponent<TextMeshPro>().text = m_Value.ToString() + "% Rate";
        }
    }
    ...
    void ActivateGate()
    {
        switch (m_GateType)
        {
            ...
            case GateType.ChangeSize:
                ...
                break;
            case GateType.ChangeAttackRate:
                PlayerController.Instance.UnitManager.AdjustAttackRate(m_Value / 100f);
                break;
        }
