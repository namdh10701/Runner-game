...
namespace Game.Run.Level
{
    ...
    public class RunnerLevelEditorWindow : EditorWindow
    {
        ...
        const string k_LevelEditorSceneName = "LevelEditor";
        const string k_LevelEditorScenePath = "Assets/_Scenes/LevelEditor.unity";
        ...
        void OnGUI()
        {
            ...
            {
                RunManager.CreateTerrain(m_LoadedLevelDefinition, ref m_TerrainGO);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                RunManager.PlaceLevelMarkers(m_LoadedLevelDefinition, ref m_LevelMarkersGO);
        ...
        void LoadLevel(LevelDefinition levelDefinition)
        {
            ...
            RunManager.LoadLevel(m_LoadedLevelDefinition, ref m_LoadedLevelGO);
            RunManager.CreateTerrain(m_LoadedLevelDefinition, ref m_TerrainGO);
            RunManager.PlaceLevelMarkers(m_LoadedLevelDefinition, ref m_LevelMarkersGO);
